...
local bankMenu = true
local banks = {
  {name="Banco", id=108, colour=4, x=150.266, y=-1040.203, z=29.374},
  {name="Banco", id=108, colour=4, x=-1212.980, y=-330.841, z=37.787},
  {name="Banco", id=108, colour=4, x=-2962.582, y=482.627, z=15.703},
  {name="Banco", id=108, colour=4, x=-112.202, y=6469.295, z=31.626},
  {name="Banco", id=108, colour=4, x=314.187, y=-278.621, z=54.170},
  {name="Banco", id=108, colour=4, x=-351.534, y=-49.529, z=49.042},
  {name="Banco", id=108, colour=4, x=241.727, y=220.706, z=106.286},
  {name="Banco", id=108, colour=4, x=1175.0643310547, y=2706.6435546875, z=38.094036102295}
}	
...
RegisterNUICallback('deposit', function(data)
	TriggerServerEvent('bank:depositarPk', tonumber(data.amount))
end)
...
RegisterNUICallback('withdrawl', function(data)
	TriggerServerEvent('bank:quitarPk', tonumber(data.amountw))
end)
...
RegisterNUICallback('balance', function()
	TriggerServerEvent('bank:balancePk')
end)
